...
namespace VitorDeSousa\AuthentikWebGuard\Services;
...
class AuthentikService
{
     ...
     */
    public const AUTHENTIK_SESSION = '_authentik_token';

    /**
     * The Session key for state
     */
    public const AUTHENTIK_SESSION_STATE = '_authentik_state';
    ...
    /**
     * Authentik OpenId Cache Configuration
     *
     * @var array
     */
     ...
     * parent constructor to comunicate with Authentik smoothly.
     *
    ...
    public function __construct(ClientInterface $client)
    {
        ...
        $this->scopes = array_merge($this->scopes, Config::get('authentik-web.scopes'));
    ...
    public function getUserProfile($credentials)
    {
        ...
        try {
            ...
            Log::error('[Authentik Service] ' . print_r($e->getMessage(), true));
        }
    ...
    protected function getOpenIdConfiguration()
    {
        ...
        try {
            ...
            throw new Exception('[Authentik Error] It was not possible to load OpenId configuration: ' . $e->getMessage());
        }
    ...
    protected function logException(GuzzleException $e)
    {
        ...
        Log::error('[Authentik Service] ' . print_r($error, true));
    }
