...
namespace VitorDeSousa\AuthentikWebGuard\Models;

use Auth;
use Illuminate\Contracts\Auth\Authenticatable;

class AuthentikUser implements Authenticatable
{
    /**
     ...
     * Constructor
     *
     * @param array $profile Authentik user info
     */
